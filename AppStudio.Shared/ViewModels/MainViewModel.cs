...
namespace AppStudio.ViewModels
{
    public class MainViewModel : BindableBase
    {
       ...
       private TracksViewModel _tracksModel;
        ...
        public TracksViewModel TracksModel
        {
            get { return _tracksModel ?? (_tracksModel = new TracksViewModel()); }
        }

        public void SetViewType(ViewTypes viewType)
        {
            AboutModel.ViewType = viewType;
            TracksModel.ViewType = viewType;
        }
        ...
        public async Task LoadDataAsync(bool forceRefresh = false)
        {
            ...
            { 
                ...
                TracksModel.LoadItemsAsync(forceRefresh),
            };
